...
public class UserService {
    ...
    private void upsertUser(BirthRegistrationApplication application, RequestInfo requestInfo){
        ...
        User user = User.builder().userName(application.getUserName())
                .password(application.getPassword())
                .name(application.getBabyFirstName())
                .gender(application.getGender())
                .mobileNumber(application.getApplicantMobileNumber())
                .emailId(application.getEmailId())
                .altContactNumber(application.getAltContactNumber())
                .permanentAddress(application.getPermanentAddress())
                .permanentCity(application.getPermanentCity())
                .permanentPincode(application.getPermanentPincode())
                .correspondenceCity(application.getCorrespondenceCity())
                .correspondencePincode(application.getCorrespondencePincode())
                .correspondenceAddress(application.getCorrespondenceAddress())
                .active(application.getActive())
                .locale(application.getLocale())
                .signature(application.getSignature())
                .accountLocked(application.getAccountLocked())
      ...
      //  application.setUserId(userServiceResponse.getUuid());
    }


    private void enrichUser(BirthRegistrationApplication application, RequestInfo requestInfo){

        String applicantMobileNumber = application.getApplicantMobileNumber();
        String tenantId = application.getTenantId();
